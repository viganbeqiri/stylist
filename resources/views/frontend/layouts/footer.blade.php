            ...
            <div class="widgets widgets-footer row">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-widget widget-info">
                        <a class="widget-info-logo" href="index.html"><img src="frontend/images/logo2.png" alt="logo"></a>
            ...
            <div class="row align-items-center">
                <div class="col-md-7">
                    <p class="tm-footer-copyright">©
                        2024. Designed by <a href="/">Suroe</a></p>
                </div>
                <div class="col-md-5">
                    <div class="tm-footer-payment">
                        <img src="frontend/images/payment-methods.png" alt="payment methods">
                    </div>
                </div>
            </div>
        </div>
